...
if __name__ == "__main__":
    ...
    likelihood_fname = '../../Data/4lh.png'
    groundtruth_fname = '../../Data/gt.png'

    likelihood = misc.imread(likelihood_fname)
    groundtruth = misc.imread(groundtruth_fname)

    likelihood = likelihood[50:200, 50:200]  # crop a piece
    groundtruth = groundtruth[50:200, 50:200] # approx gt using likelihood
    ...
    print('here', pd_lh.shape, bcp_lh.shape, dcp_lh.shape)
    pd_gt, bcp_gt, dcp_gt = compute_persistence_2DImg_1DHom(groundtruth)
    print('here2',pd_gt.shape, bcp_gt.shape, dcp_gt.shape)
