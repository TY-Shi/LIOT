...
def compute_persistence_2DImg_1DHom(f):
    ...
    persistence_result_filtered = np.array(list(filter(lambda x: x[0] == 2,
                                                  persistence_result)))
...
if __name__ == "__main__":
    ...
    #likelihood_fname = '../../Data/result1.png'
    #tmpX = misc.imread(likelihood_fname)
    #likelihood = tmpX
    #likelihood = likelihood[100:150, 100:150]  # crop a piece
    #groundtruth = likelihood > 0.9 # approx gt using likelihood

    # result_folder = '../../Results/'
    # # likelihood_fname = 'Data/result_unet.png'
    # # groundtruth_fname = 'Data/gt.png'
    #
    # likelihood_fname = '../../Data/patch2_epoch10_lh.png'
    # groundtruth_fname = '../../Data/patch2_gt.png'
    #
    # likelihood = misc.imread(likelihood_fname)
    # groundtruth = misc.imread(groundtruth_fname)
    #
    # likelihood = likelihood[50:115, 50:115]  # crop a piece
    # groundtruth = groundtruth[50:52, 50:52] # approx gt using likelihood

    result_folder = '../../Results/'
    likelihood_fname = '../../Data/likelihood.npy'
    tmpX = np.load(likelihood_fname)
    likelihood = tmpX[1, :, :, :] # take one slice
    likelihood = likelihood[100:150, 100:150,:]  # crop a piece
    groundtruth = likelihood > 0.9 # approx gt using likelihood

    # save the loaded (and modified) lh, gt
    # np.save(result_folder + 'likelihood_cropped_15.npy', likelihood)
    # plt.imsave(result_folder + 'likelihood.png', likelihood, cmap='gray')
    ...
    # torus_c = SimplicialComplex(simplices=groundtruth)
